...
class AcademicWidgetPolicyTest {
    @Test fun oneProviderSelectsThreeLayouts() {
        assertEquals(AcademicWidgetLayout.COMPACT, AcademicWidgetPolicy.layout(70, 70))
        assertEquals(AcademicWidgetLayout.SUMMARY, AcademicWidgetPolicy.layout(140, 70))
        assertEquals(AcademicWidgetLayout.SUMMARY, AcademicWidgetPolicy.layout(140, 140))
        assertEquals(AcademicWidgetLayout.SUMMARY, AcademicWidgetPolicy.layout(110, 110))
        ...
        for (width in listOf(110, 180, 250, 320, 600)) {
            for (height in listOf(40, 110, 180, 249))
                assertEquals(AcademicWidgetLayout.SUMMARY, AcademicWidgetPolicy.layout(width, height))
