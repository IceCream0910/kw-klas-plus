...
class LockActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (mode == Mode.UNLOCK && AppLockManager.isBiometricEnabled(this) && AndroidBiometricAvailability.canAuthenticate(this)) {
            showBiometricPrompt()
        }
    }
    ...
    private fun updateModeUI() {
        when (mode) {
            Mode.UNLOCK -> {
                ...
                btnBiometric.visibility = if (AppLockManager.isBiometricEnabled(this) && AndroidBiometricAvailability.canAuthenticate(this)) View.VISIBLE else View.GONE
            }
            Mode.SET -> {
